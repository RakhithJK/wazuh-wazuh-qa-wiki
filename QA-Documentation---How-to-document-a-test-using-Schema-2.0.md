...
| tier         | int    | Mandatory | Tier covered by the test.                                      | 0, 1, 2, ...                                                                       |
| test_phases         | List    | Optional | A list that describes the test's steps                                      | - Mock an agent with OBSOLETE vulnerabilities in the vuln_cves inventory - Update sync_info packages data for that mocked_agent |
...
| components            | `active_response`, `agentd`, `analysisd`, `api`, `authd`, `cluster`, `fim`, `gcloud`, `github`, `logcollector`, `logtest`, `office365`, `remoted`, `rids`, `rootcheck`, `vulnerability_detector`, `wazuh_db`, `wpk` |
...
| tags               | `active_response`, `agentd`, `alas_feeds`, `alerts`, `analysisd`, `api`, `ar_analysisd`, `ar_execd`, `archlinux`, `archlinux_feeds`, `auditd`, `audit_keys`, `audit_rules`, `authd`, `aws`, `basic_configuration`, `brute_force_attack`, `cache`, `canonical`, `canonical_feeds`, `cdb`, `cluster`, `config`, `cors`, `cpe`, `cpe_helper`, `debian`, `debian_feeds`, `decoder`, `diff`, `disk_quota`, `dos_attack`, `download`, `enrollment`, `errors`, `events`, `experimental`, `feeds`, `fernet`, `fim`, `fim_ambiguous_confs`, `fim_audit`, `fim_basic_usage`, `fim_benchmark`, `fim_checks`, `fim_env_variables`, `fim_file_limit`, `fim_follow_symbolic_link`, `fim_ignore`, `fim_inotify`, `fim_invalid`, `fim_max_eps`, `fim_max_files_per_second`, `fim_moving_files`, `fim_multiple_dirs`, `fim_nodiff`, `fim_prefilter_cmd`, `fim_report_changes`, `fim_process_priority`, `fim_recursion_level`, `fim_restrict`, `fim_scan`, `fim_skip`, `fim_stats_integrity_sync`, `fim_tags`, `fim_timezone_changes`, `fim_wildcards_complex`, `fim_windows_audit_interval`, `fim_registry_ambiguous_confs`, `fim_registry_basic_usage`, `fim_registry_checks`, `fim_registry_ignore`, `fim_registry_nodiff`, `fim_registry_file_limit`, `fim_registry_multiple_registries`, `fim_registry_recursion_level`, `fim_registry_report_changes`, `fim_registry_restrict`, `fim_registry_tags`, `fim_synchronization`, `gcloud`, `general_settings`, `github`, `github_configuration`, `inactivity`, `integrity`, `invalid`, `invalid_settings`, `keys`, `key_polling`, `limits`, `logcollector`, `logcollector_age`, `logcollector_cmd_exec`, `logcollector_configuration`, `logcollector_keep_running`, `logcollector_location`, `logcollector_location_cust_sockets`, `logcollector_log_format`, `logcollector_macos`, `logcollector_only_future_events`, `logcollector_options`, `logcollector_reconnect_time`, `logcollector_statistics`, `logs`, `logtest`, `logtest_configuration`, `logtest_invalid_rule_decoder_syntax`, `logtest_invalid_socket_input`, `logtest_invalid_token`, `logtest_log_process_options`, `logtest_remove_old_sessions`, `logtest_remove_session`, `logtest_rules_decoders_load`, `logtest_ruleset_refresh`, `man_in_the_middle`, `master`, `maximum`, `mitre`, `msu`, `msu_feeds`, `nvd`, `office365`, `on_start`, `oval`, `prelink`, `providers`, `pull`, `rbac`, `realtime`, `redhat`, `redhat_feeds`, `remoted`, `rids`, `rootcheck`, `rules`, `scan`, `scan_results`, `scan_types`, `scheduled`, `scheduled`, `session_error`, `session_limit`, `settings`, `simulator`, `ssl`, `stats_file`, `system_inventory`, `time_travel`, `token`, `vulnerability`, `vulnerability_detector`, `wazuh_db`, `wdb_socket`, `week_day`, `who_data`, `windows`, `worker`, `wpk` |
